...
public enum HeatTransferCoefficientUnits implements HeatTransferCoefficientUnit {
    ...
    WATTS_PER_SQUARE_METER_KELVIN("W/(m²·K)", 1.0),
    KILOWATTS_PER_SQUARE_METER_KELVIN("kW/(m²·K)", 1.0E3),
    BTU_PER_HOUR_SQUARE_FOOT_FAHRENHEIT("BTU/(h·ft²·°F)", UnitDefinitions.BTU_PER_HOUR_SQUARE_FOOT_FAHRENHEIT_DEGREE),
    BTU_PER_MINUTE_SQUARE_FOOT_FAHRENHEIT("BTU/(min·ft²·°F)", UnitDefinitions.BTU_PER_MINUTE_SQUARE_FOOT_FAHRENHEIT_DEGREE);
     ...
     * with the forward.
     */
    HeatTransferCoefficientUnits(String symbol, double scaleToBase) {
