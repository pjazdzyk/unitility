...
final class PhysicalQuantityDefaultParsingFactory extends PhysicalQuantityAbstractParsingFactory {
    ...
    private PhysicalQuantityDefaultParsingFactory() {
        ...
        this.immutableParsingRegistry = Map.<Class<?>, BiFunction<Double, String, ? extends PhysicalQuantity<?>>>ofEntries(
                ...
                Map.entry(SpecificFanPower.class, SpecificFanPower::of),
                ...
                Map.entry(TemperatureDifference.class, TemperatureDifference::of),
                ...
                Map.entry(AirFuelRatioVolume.class, AirFuelRatioVolume::of),
                Map.entry(AirFuelRatioMass.class, AirFuelRatioMass::of),
        ...
        this.immutableDefaultUnitRegistry = Map.<Class<?>, Unit>ofEntries(
                ...
                Map.entry(Ratio.class, RatioUnits.DECIMAL),
                Map.entry(Effectiveness.class, EffectivenessUnits.DECIMAL),
                ...
                Map.entry(SpecificFanPower.class,
                        SpecificFanPowerUnits.WATT_PER_CUBIC_METER_PER_SECOND),
                ...
                Map.entry(TemperatureDifference.class, TemperatureDifferenceUnits.KELVIN),
                ...
                Map.entry(AirFuelRatioVolume.class, AirFuelRatioVolumeUnits.CUBIC_METER_PER_CUBIC_METER),
                Map.entry(AirFuelRatioMass.class, AirFuelRatioMassUnits.KILOGRAM_PER_KILOGRAM),
