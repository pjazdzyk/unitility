...
public enum LinearHeatFluxUnits implements LinearHeatFluxUnit {
    ...
    WATTS_PER_METER("W/m", 1.0),
    KILOWATTS_PER_METER("kW/m", 1.0E3),
    BTU_PER_HOUR_FOOT("BTU/(h·ft)", UnitDefinitions.BTU_PER_HOUR_FOOT),
    BTU_PER_MINUTE_FOOT("BTU/(min·ft)", UnitDefinitions.BTU_PER_MINUTE_FOOT);
     ...
     * with the forward.
     */
    LinearHeatFluxUnits(String symbol, double scaleToBase) {
