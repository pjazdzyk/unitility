...
public enum ReynoldsNumberUnits implements ReynoldsNumberUnit {
     ...
     * with the forward.
     */
    ReynoldsNumberUnits(String symbol, double scaleToBase) {
    ...
    @Override
    public ReynoldsNumberUnit getBaseUnit() {
